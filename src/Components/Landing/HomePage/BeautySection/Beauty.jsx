		...
		>
			<div className="flex" data-aos="fade-up" data-aos-once="false">
				...
				<div className="flex flex-col gap-[20px] md:gap-[27px] items-center justify-center max-w-[939px] mx-auto px-[18px] z-[1]">
					<h2 className="font-PrimeCast text-[28px] md:text-[30px] 901px:text-[34px] tracking-[4.3px] leading-[46px] mb-[-10px] md:mb-0 text-center">
						Clean Beauty with Proven Power
					</h2>
					<p className="sm:text-[19px] md:text-[21px] lg:text-[23px] text-center md:leading-[30px] md:max-w-[640px] lg:max-w-[903px]">
