...
const HeroL = () => {
	return (
		<section className="pt-5 sm:pt-10 md:pt-[222px] xl:ps-[65px] 2xl:ps-[99px] pb-14 md:pb-[90px] lg:pb-[127px] w-full">
			<h1
				className="text-[27px] sm:text-[35px] md:text-[30px] lg:text-[40px] xl:text-[50px] xl:leading-[64px] text-white font-bold font-lora max-w-[315px] sm:max-w-[400px] md:max-w-[479px] xl:max-w-[570px] tracking-[0.6px]"
			>
				Plump, Firm, and Radiant Skin in One Jar
			</h1>

			<p
				className="mt-[15px] max-w-[400px] sm:max-w-[470px] text-[13px] sm:text-base md:text-[13px] lg:text-base tracking-[0.3px] sm:leading-[20px] text-white lg:font-medium"
			>
